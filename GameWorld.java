...
public class GameWorld extends World
{
    ...
    { 
        super(1200, 768, 1); 
        setPaintOrder(Cursor.class, CollisionBox.class, TextBox.class, Picture.class, Cell.class, SuperStatBar.class, Entity.class, Aura.class, CellEffect.class, Tile.class);
        Mouse.setWorld(this);
