...
public  class StatsUI extends UI
{
    ...
    private static LoadBar cdBar1 = new LoadBar(100, 4, Color.WHITE, Color.GREEN, false);
    private static LoadBar cdBar2 = new LoadBar(75, 10, Color.WHITE, false);
    ...
    private PopUpBox atkStatInfo = new PopUpBox(new SuperTextBox(new String []{"- Strength Stat -", "Determines the ",  "attack damage you","deal to enemies."}, new Font(12), 120), 55, 75);
    private PopUpBox hpStatInfo = new PopUpBox(new SuperTextBox(new String []{"- Health Stat -", "Determines the ",  "hit points you have."}, new Font(12), 120), 55, 75);
    private PopUpBox spdStatInfo = new PopUpBox(new SuperTextBox(new String []{"- Speed Stat -", "Determines how ",  "fast you move."}, new Font(12), 120), 55, 75);
    
    private PopUpBox staffInfo = new PopUpBox(new SuperTextBox(new String []{"- Staff Meter -", "This meter determines",  "how long you can"," use the staff."}, new Font(12), 130), 70, 35);
    ...
    private TextBox coinText = new TextBox(Integer.toString(coin), 24, Color.YELLOW, null, 0, 255);
